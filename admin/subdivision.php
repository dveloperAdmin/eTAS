...
$des="load Sub-Division-ui page";
$rem="Sub-Division details page";
$header="Sub-Division Details";
$headerDes="Sub-Division Entry";
include '../include/_audiLog.php'; 
include '../include/_licCheck.php'; 

$Tabledata = sqlsrv_query($conn,"select * from subDivisionDetails");
            ...
            <div class="card">
              <div class="card-body" id="comFrom">
                <div class="border p-3 rounded">
                  <h6 class="mb-0 text-uppercase">New Sub-Division</h6>
                  <hr />
                  <form action="admin/process/masterSetupProcess.php" method="post" class="row g-3">

                    <div class="col-12">
                      <label class="form-label">Sub-Division Name</label>
                      <input type="text" class="form-control" placeholder="Enter the Sub-Division name"
                        name="subdivName" required autofocus />
                    </div>
                    <div class="col-12">
                      <div class="d-grid">
                        <button type="submit" class="btn btn-success" name="subdivAdd">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <h5 class="mb-0">Sub-Division Details</h5>
                ...
                <div class="table-responsive mt-3 mst-2" id="reloadTable">
                  <table class="table align-middle comTable" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo ++$i;?></td>
                        <td><?php echo $tableDataFetch['subDiviCode'];?></td>
                        <td><?php echo $tableDataFetch['subDivision'];?></td>
                        <input type="hidden" value="subdiv">
                        <td>
