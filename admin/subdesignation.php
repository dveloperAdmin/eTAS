...
$des="load Sub-Designation-ui page";
$rem="Sub-Designation details page";
$header="Sub-Designation Details";
$headerDes="Sub-Designation Entry";
include '../include/_audiLog.php'; 
include '../include/_licCheck.php'; 

$branchTabledata = sqlsrv_query($conn,"select * from subDesignationDetails");
            ...
            <div class="card">
              <div class="card-body" id="comFrom">
                <div class="border p-3 rounded">
                  <h6 class="mb-0 text-uppercase">New Sub-Designation</h6>
                  <hr />
                  <form action="admin/process/masterSetupProcess.php" method="post" class="row g-3">

                    <div class="col-12">
                      <label class="form-label">Sub-Designation Name</label>
                      <input type="text" class="form-control" placeholder="Enter the Sub-Designation name"
                        name="subdesigName" required autofocus />
                    </div>
                    <div class="col-12">
                      <div class="d-grid">
                        <button type="submit" class="btn btn-success" name="subdesigAdd">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <h5 class="mb-0">Sub-Designation Details</h5>
                ...
                <div class="table-responsive mt-3 mst-2" id="reloadTable">
                  <table class="table align-middle comTable" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo ++$i;?></td>
                        <td><?php echo $tableDataFetch['subDesigCode'];?></td>
                        <td><?php echo $tableDataFetch['subDesignation'];?></td>
                        <input type="hidden" value="subdesig">
                        <td>
