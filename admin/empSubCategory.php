...
$des="load Emp.Sub-Category-ui page";
$rem="Emp.Sub-Category details page";
$header="Emp.Sub-Category Details";
$headerDes="Emp.Sub-Category Entry";
include '../include/_audiLog.php'; 
include '../include/_licCheck.php'; 

$Tabledata = sqlsrv_query($conn,"select * from empSubCategoryDetails");
            ...
            <div class="card">
              <div class="card-body" id="comFrom">
                <div class="border p-3 rounded">
                  <h6 class="mb-0 text-uppercase">New Emp. Sub-Category</h6>
                  <hr />
                  <form action="admin/process/masterSetupProcess.php" method="post" class="row g-3">

                    <div class="col-12">
                      <label class="form-label">Emp. Sub-Category Name</label>
                      <input type="text" class="form-control" placeholder="Enter the Emp. Sub-Category name"
                        name="empsubcatName" required autofocus />
                    </div>
                    <div class="col-12">
                      <div class="d-grid">
                        <button type="submit" class="btn btn-success" name="empsubcatAdd">
                          <i class="bi bi-plus-lg"></i>
                          Add Emp.Sub-Category
                        </button>
                      </div>
                    </div>
                  </form>
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex align-items-center">
                  <h5 class="mb-0">Emp.Sub-Category Details</h5>
                ...
                <div class="table-responsive mt-3 mst-2" id="reloadTable">
                  <table class="table align-middle comTable" id="dataTable">
                    <thead class="table-secondary table-header">
                      <tr>
                        <th>Count</th>
                        <th>Emp.Sub-Category Code</th>
                        <th>Emp.Sub-Category Name</th>
                        <th>Actions</th>
                      </tr>
                    </thead>
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo ++$i;?></td>
                        <td><?php echo $tableDataFetch['empSubCatCode'];?></td>
                        <td><?php echo $tableDataFetch['empSubCategory'];?></td>
                        <input type="hidden" value="empsubcat">
                        <td>
