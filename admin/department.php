...
$des="load Department-ui page";
$rem="Department details page";
$header="Department Details";
$headerDes="Department Entry";
include '../include/_audiLog.php'; 
include '../include/_licCheck.php'; 

$branchTabledata = sqlsrv_query($conn,"select * from departmentDetails");
                ...
                <div class="border p-3 rounded">
                  ...
                  <form action="admin/process/masterSetupProcess.php" method="post" class="row g-3">
                    ...
                    <div class="col-12">
                      ...
                      <input type="text" class="form-control" placeholder="Enter the Department name" name="deptName"
                        autofocus required />
                    </div>
                    <div class="col-12">
                      <div class="d-grid">
                        <button type="submit" class="btn btn-success" name="deptAdd">
                ...
                <div class="table-responsive mt-3 mst-2" id="reloadTable">
                  <table class="table align-middle comTable" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo ++$i;?></td>
                        <td><?php echo $tableDataFetch['deptCode'];?></td>
                        <td><?php echo $tableDataFetch['department'];?></td>
                        <input type="hidden" value="dept">
                        <td>
