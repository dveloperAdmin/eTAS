...
$des="load Grade-ui page";
$rem="Grade details page";
$header="Grade Details";
$headerDes="Grade Entry";
include '../include/_audiLog.php'; 
include '../include/_licCheck.php'; 

$Tabledata = sqlsrv_query($conn,"select * from gradeDetails");
            ...
            <div class="card">
              <div class="card-body" id="comFrom">
                <div class="border p-3 rounded">
                  <h6 class="mb-0 text-uppercase">New Grade</h6>
                  <hr />
                  <form action="admin/process/masterSetupProcess.php" method="post" class="row g-3">

                    <div class="col-12">
                      <label class="form-label">Grade </label>
                      <input type="text" class="form-control" placeholder="Enter the Grade " name="gradeName" required
                        autofocus />
                    </div>
                    <div class="col-12">
                      <div class="d-grid">
                        <button type="submit" class="btn btn-success" name="gradeAdd">
                ...
                <div class="table-responsive mt-3 mst-2" id="reloadTable">
                  <table class="table align-middle comTable" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo ++$i;?></td>
                        <td><?php echo $tableDataFetch['gradeCode'];?></td>
                        <td><?php echo $tableDataFetch['grade'];?></td>
