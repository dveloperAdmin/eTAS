...
$des="load Division-ui page";
$rem="Division details page";
$header="Division Details";
$headerDes="Division Entry";
include '../include/_audiLog.php'; 
include '../include/_licCheck.php'; 

$Tabledata = sqlsrv_query($conn,"select * from divisionDetails");
            ...
            <div class="card">
              <div class="card-body" id="comFrom">
                <div class="border p-3 rounded">
                  <h6 class="mb-0 text-uppercase">New Division</h6>
                  <hr />
                  <form action="admin/process/masterSetupProcess.php" method="post" class="row g-3">

                    <div class="col-12">
                      <label class="form-label">Division Name</label>
                      <input type="text" class="form-control" placeholder="Enter the Division name" name="divisionName"
                        required autofocus />
                    </div>
                    <div class="col-12">
                      <div class="d-grid">
                        <button type="submit" class="btn btn-success" name="divisionAdd">
                ...
                <div class="table-responsive mt-3 mst-2" id="reloadTable">
                  <table class="table align-middle comTable" id="dataTable">
                    ...
                    <tbody>
                      ...
                      <tr>
                        <td><?php echo ++$i;?></td>
                        <td><?php echo $tableDataFetch['divisionCode'];?></td>
                        <td><?php echo $tableDataFetch['division'];?></td>
